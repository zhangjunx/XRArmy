getVender();
getType();
getDevice({"dotid":getUrlParam("id")});
...
$("#resetData").click(function(){
	...
	var dotid=getUrlParam("id");//监控点的id  
	var obj={"dotid":dotid,"type":"dd","str":JSON.stringify(arr),"loginid":window.top.loginid};
	$.ajax({
		url:url+"/MonitorDotDevice/add",
		type:"POST",
		data:obj,
...
function saveInfo(){
	...
	var dotid=getUrlParam("id");//监控点的id  
	var obj={"dotid":dotid,"type":"aa","str":JSON.stringify(arr),"loginid":window.top.loginid};
	$.ajax({
		url:url+"/MonitorDotDevice/add",
		type:"POST",
		data:obj,
...
function getDevice(obj){
	$.ajax({
		url:url+"/MonitorDotDevice/getDevList",
		type:"POST",
		data:obj,
		success:function(data){
			console.log(data)
