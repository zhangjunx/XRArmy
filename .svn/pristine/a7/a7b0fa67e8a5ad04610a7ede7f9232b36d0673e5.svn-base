	 ...
	 var $ = layui.$,
	  ...
	  table.render({
		    ...
		    cols:  [[
			      ...
			      {field:'holdername', title:'人员姓名', width:200,sort:true},
			      {field:'channelname', title:'报警通道', width:200,sort:true},
				  {field:'iostatus', title:'进出状态',width:150, sort:true,function(d){
					  if(d.iostatus=="11"){
						  return "进入";
				  ...
				  {field:'sourcename', title:'报警来源', width:200,sort:true},
