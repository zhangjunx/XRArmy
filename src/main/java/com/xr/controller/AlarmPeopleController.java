...
@Controller
@RequestMapping("AlarmPeople")
@Api(tags="AlarmPeople",description="接口标题：人员报警记录层接口")
public class AlarmPeopleController {
	@Autowired
	private IAlarmPeopleService ics;
	...
	@ApiImplicitParams({
		@ApiImplicitParam(name="holdername",value="参数：姓名:模糊查询时传参",dataType="String",paramType="path"),
		@ApiImplicitParam(name="channelno",value="参数：报警通道",dataType="String",paramType="path"),
		@ApiImplicitParam(name="sourcename",value="参数：报警来源",dataType="String",paramType="path"),
	...
	@MethodLog(methodName="新增",remark="新增人员报警记录")
	@RequestMapping(value="/insert",method=RequestMethod.POST)
	@ResponseBody
	public Map<String,Object> insert(AlarmPeople record,String loginid){
	...
	@ApiImplicitParams({
		...
		@ApiImplicitParam(name="state",value="参数：状态:1已处理，0未处理",dataType="String",paramType="path"),
		@ApiImplicitParam(name="loginid",value="参数：登录人id",dataType="String",paramType="path")
	})
	@MethodLog(methodName="修改",remark="处理人员报警记录")
	@RequestMapping(value="/update",method=RequestMethod.POST)
	@ResponseBody
	public Map<String,Object> update(AlarmPeople record,String loginid){
		Map<String,Object> map=new HashMap<String,Object>();
		Map<String,Object> m=new HashMap<String,Object>();
		try{
	...
	@MethodLog(methodName="删除",remark="删除人员报警记录")
	...
	@ResponseBody
	public Map<String,Object> getList(AlarmPeople record,String loginid,Integer curpage,Integer pagesize){
		Map<String,Object> map=new HashMap<String,Object>();
		Map<String,Object> m=new HashMap<String,Object>();
		try{
			...
			for(int i=0;i<list.size();i++){
				...
				if(photostr!=null && !"".equals(photostr) && !"null".equals(photostr)){
					String imgUrl=ImagePathConfig.alarmpeoplepic+"/"+photostr;
