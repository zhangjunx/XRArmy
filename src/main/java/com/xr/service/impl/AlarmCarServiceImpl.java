...
import com.xr.mapper.AlarmCarMapper;
import com.xr.entry.AlarmCar;
import com.xr.entry.AlarmPeople;
import com.xr.service.IAlarmCarService;
@Service
public class AlarmCarServiceImpl implements IAlarmCarService {

	@Autowired
	private AlarmCarMapper dm;

	@Override
	public int insertSelectiveService(AlarmCar record) {
		// 新增
	...
	@Override
	public AlarmCar selectByPrimaryKeyService(Integer id) {
		// 查询
	...
	@Override
	public int updateByPrimaryKeySelectiveService(AlarmCar record) {
