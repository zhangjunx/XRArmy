...
//	  			{field:'reportLocal', title:'报到地点', width:120,sort:true},
	  			{field:'carStatus', title:'车辆状态', width:200,sort:true,templet:function(d){
	  			      //不是已经审批的单据，不做出行状态判断
	...
	function carOutLier(){
		table.render({
  		    ...
  		    cols:[[
  				  ...
  				  {field:'billNo', title:'单号', width:250,sort:true},
	  			  {field:'carNum', title:'车牌号码', width:180,sort:true},
	  			  {field:'driverName', title:'驾驶员', width:180,sort:true},
	  			  {field:'phoneNum', title:'联系方式', width:180,sort:true},
	  			  {field:'errorTypeName', title:'异常类型', width:300,sort:true},
	  			  {field:'operateDate', title:'操作时间', width:180,sort:true},
