		   ...
		   parseData: function(res){ //res 即为原始返回的数据
		    ...
		    cols:  [[
				  ...
				  {field:'photo', title:'现场照', width:200,sort:true,templet:function(d){
					  ...
					  return "<img src="+photo+" id='img"+d.LAY_TABLE_INDEX+"' data-original="+photo+" class='door_img' style='width:100%;height:100%;object-fit:contain'>";
				  }},
			 ...
			 limits:[15,20,30,40,50,60,70,80,90],
				 ...
				 for(let i=0;i<$(".door_img").length;i++){
					 var image = new Viewer(document.getElementById('img'+i),{
		           		 url: 'data-original',
		           		 title:false,
		           		 toolbar:false,
		           	});
