		 ...
		 var $ = layui.$,
		  ...
		  table.render({
			    ...
			    cols:  [[
					  ...
					  {field:'vid', title:'访客编号', width:200,sort:true,templet:function(d){
						  return "V_"+d.id;
					  }},
				      {field:'visitorsname', title:'访客名称', width:200,sort:true},
					  {field:'photo', title:'访客照片', width:200,sort:true,templet:function(d){
					      var photo=d.photo==undefined?"../img/add_img.png":d.photo;
					      return "<img src="+photo+" style='height:60px;object-fit:contain'>";
					  }},
					  {field:'visitorsreasontext', title:'来访事由', width:200,sort:true},
					  {field:'carplateno', title:'车牌号码', width:200,sort:true},
					  {field:'startdate', title:'开始时间', width:250,sort:true},
					  {field:'enddate', title:'结束时间', width:250,sort:true},
				    ]],
//				    page: true,
//				    limit:15,
...
function saveInfo(boxid,boxip,holderno,holdername,photostr,i,num,index){
	var obj={"boxid":boxid,"boxip":boxip,"holderno":holderno,"holdername":holdername,
			"state":"0","photostr":photostr,"loginid":window.top.loginid};
	$.ajax({
