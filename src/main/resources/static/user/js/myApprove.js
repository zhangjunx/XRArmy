	  	 ...
	  	 table.render({
	  		    ...
	  		    cols:  [[
	  				 ...
	  				 {fixed:'right',title:'操作', width:200,templet:function(){
						  var $a1="<a class='layui-btn layui-btn-normal layui-btn-xs' lay-event='agree'>同意</a>";
						  var $a2="<a class='layui-btn layui-btn-danger layui-btn-xs' lay-event='refuse'>驳回</a>";
						  return $a1+$a2;
					  }}
	  			    ]]
	  		    ,page: true
